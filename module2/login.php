...
<head>
      <title>Student Login</title><meta charset="UTF-8" />
  ...
  if(isset($_POST['submit'])){
    ...
    //if($errMsg == ''){
        if($email && $password){
            ...
            $queryLogin = "SELECT * FROM user WHERE email='$email' AND password='$password' and type='2' ";
            $queryFail = "SELECT * FROM user WHERE email='$email' AND password='$password' and type='1' ";
